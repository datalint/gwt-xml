...
import gwt.xml.test.shared.XmlTestUtil;
...
public class App implements EntryPoint {
    ...
    public void onModuleLoad() {
        AssertionsC.setMessageConsumer((isPositive, message) -> body().appendChild(p().css(isPositive ?
                null : error).textContent(message).setColor((isPositive ? Color.GREEN : Color.RED).getName())));
        ...
        assertEquals("abc", XmlTestUtil.lower("ABC"));
    }
